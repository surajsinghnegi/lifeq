...
myApp.onPageInit('infinite-scroll', function(page) {
	...
	/* Last Loaded Index */
	var lastIndex = $$('.page[data-page=infinite-scroll] .list2-block li').length;
	...
	$.ajax({
        ...
        success:function(data)
        {
          ...
          error: function(){
			...
			// 	html += '<li><div class="item-content card"><div class="item-inner"><div class="item-title">Item ' + i + '</div></div></div></li>';
			// }
